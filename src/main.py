...
#parser.add_argument('--train_file', type=str, default='./data/20170101.json', help='path to the training file')
#parser.add_argument('--test_file', type=str, default='./data/20170101.json', help='path to the test file')
